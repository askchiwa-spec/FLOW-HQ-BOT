            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:business@chatisha.com" className="text-secondary-400 hover:text-secondary-300 transition-colors">
                    business@chatisha.com
                  </a>
                  <p className="text-slate-500 text-xs mt-0.5">Getting started, pricing, partnerships</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:support@chatisha.com" className="text-primary-400 hover:text-primary-300 transition-colors">
                    support@chatisha.com
                  </a>
                  <p className="text-slate-500 text-xs mt-0.5">Technical help, account issues, bot problems</p>
                </div>
              </div>
